...
export default function CustomModal({
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden outline-none select-none focus:outline-none bg-neutral-800 bg-opacity-40">
